...
| $$       \$$    $$| $$      
 \$$        \$$$$$$  \$$      
EOF
    echo -e "${cyan}🔥 Feni Cyber Force Termux Tool 🔥${nc}"
    echo -e "${green}📘 FB:${nc} https://facebook.com/feni.cyber.force.official"
    echo -e "${green}📢 TG:${nc} https://t.me/feni_cyber_force"
    echo ""
}
...
setup_termux_banner() {
    ...
    cat << 'EOF' > $BANNER_FILE
figlet "F.C.F" | lolcat
echo -e "\e[1;96m🔥 Welcome to Feni Cyber Force Tools 🔥\e[0m"
EOF
